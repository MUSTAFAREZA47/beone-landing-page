...
const mmxVideos = [
    ...
    {
        id: 3,
        title: 'Strategy Of Money Machine X',
        url: 'https://www.youtube.com/watch?v=xoBpoQPmhjM',
    },
    {
        id: 4,
        title: 'Time Filter & Equity Gurdian In MMX',
        url: 'https://www.youtube.com/watch?v=hwy0AO4_YeU',
    },
    {
        id: 5,
        title: 'News Filter In Money Machine X',
        url: 'https://www.youtube.com/watch?v=hWKfepgHYGc',
    },
    {
        id: 6,
        title: 'Price Ranger In Money Machine X',
        url: 'https://www.youtube.com/watch?v=Qdr-hYDWlvs',
    },
    {
        id: 7,
        title: 'Basic Prop Firm Setup Rules & Recommendation',
        url: 'https://www.youtube.com/watch?v=GhQ138ymJ6I',
    },
    {
        id: 8,
        title: 'Support & Resistance In MMX',
        url: 'https://www.youtube.com/watch?v=jRqvDqoFrxE',
    },
]
    ...
    return (
        <div className="min-h-screen bg-black text-white">
            ...
            <main className="pt-24 pb-16 px-4 sm:px-6 lg:px-8">
                <h1 className="text-center text-3xl sm:text-4xl md:text-5xl font-bold bg-gradient-to-r from-blue-500 to-indigo-600 bg-clip-text text-transparent">
                    🎓 Premium Video Content
                </h1>
                <div className="h-1 bg-gradient-to-r from-blue-500 to-indigo-600 w-24 mx-auto mt-4 rounded-full"></div>

                {/* Money Machine X Videos */}
                <div className="max-w-7xl mx-auto">
                    <motion.div
                        initial={{ opacity: 0, y: 20 }}
                        animate={{ opacity: 1, y: 0 }}
                        transition={{ duration: 0.6 }}
                        className="text-center mb-8 mt-8 sm:mb-16"
                    >
                        <p className="mt-4 text-gray-300 text-lg sm:text-xl">
                            Money Machine X Content
                        </p>
                    </motion.div>

                    <div className="grid gap-6 sm:gap-8 grid-cols-1 lg:grid-cols-2">
                        {mmxVideos.map((video, index) => (
                            <motion.div
                                key={video.id}
                                initial={{ opacity: 0, y: 20 }}
